...
import com.raining.subject.application.convert.SubjectAnswerDTOConverter;
import com.raining.subject.application.convert.SubjectInfoDTOConverter;
import com.raining.subject.application.dto.SubjectInfoDTO;
...
public class SubjectController {
    ...
    public Result<Boolean> pushMessage(@Param("id") int id) {
        rabbitTemplate.convertAndSend("test.queue", "早上好" + id);
        return Result.ok(true);
    }
